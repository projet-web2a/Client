                        ...
                        <tr>
                            <td>
                                ...
                                <a href="http://pixelbuddha.net/" style="display:block; width:407px; height:100px; margin:0 auto 30px;">
                                    <img src="http://291b35bc.ngrok.io/projetWeb/views/back/images/logo_newsletter.png" width="407" height="100" alt="Pixelbuddha" style="display:block; border:0; margin:0;">
                                </a>
                                                        ...
                                                        <tr valign="top">
                                                          <td width="30"><p style="margin:0; font-size:1px; line-height:1px;">&nbsp;</p></td>
                                                            <td>
                                                                ...
                                                                <p style="margin:0 0 4px; font-size:12px; line-height:18px; color:#333333;">Your request was confirmed by EyeZone. </p>
                                                ...
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    <tbody>
                                                        <tr valign="top">
                                                            <td width="30"><p style="margin:0; font-size:1px; line-height:1px;">&nbsp;</p></td>
                                                            <td>
                                                                <p style="margin:0 0 4px; font-weight:bold; color:#333333; font-size:14px; line-height:22px;">EyeZone.</p>
                                                                <p style="margin:0; color:#333333; font-size:11px; line-height:18px;"><!--
                                                                    400005 Russian Federation, Volgograd, prospekt Lenina 56--><br>
                                                                    Contact: wafa.rabeh@gmail.com<br>
                                                                    Website: <a href="http://291b35bc.ngrok.io/Projet/views/front/index1.php" style="color:#6d7e44; text-decoration:none; font-weight:bold;">www.EyeZone.com</a>
                                                                </p>
                                                            </td>
                                                            <td width="30"><p style="margin:0; font-size:1px; line-height:1px;">&nbsp;</p></td>
                                                            <td width="120">
                                                                ...
                                                                -->
                                                                    <a href="http://291b35bc.ngrok.io/Projet/views/front/index1.php" style="color:#6d7e44; text-decoration:none;">Visit website</a>
                                                                </p>
                                                            </td>
                                                            <td width="30"><p style="margin:0; font-size:1px; line-height:1px;">&nbsp;</p></td>
                                                        </tr>
