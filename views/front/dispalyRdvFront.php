			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light top-header mb-2">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav nav-mega mx-auto">
                        ...
                        <li class="nav-item">
							<a class="nav-link" href="rdv.html">rendezvous</a>
						</li>
					</ul>
...
<div class="card-body mb-3" style="max-width: 54rem;">
  ...
  <thead>
    <tr>
      <th scope="col" class="" style="background-color:#F25613">Id</th>
      <th scope="col" class="" style="background-color:#F25613">Date</th>
      <th scope="col" class="" style="background-color:#F25613">Time</th>
      <th scope="col" class="" style="background-color:#F25613">Product.Ref</th>
	  <th scope="col" class="" style="background-color:#F25613">Action</th>
    </tr>
  </thead>
  <tbody>
<?php foreach($listeRdv as $Rdv): ?>
    <tr>
      ...
      <td>
              <a  href="editRdv.php?idR=<?= $Rdv->id_rdv ?>" class="btn btn-dark"> Edit </a>
			  <a  onclick="return confirm('Are you sure you want to delete this Rdv ?')" href="deleteRdv.php?idR=<?= $Rdv->id_rdv ?>" class="btn btn-dark"> Delete </a>
